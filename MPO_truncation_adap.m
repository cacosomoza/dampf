function [A_normalized, truncerr, chi_vec] = MPO_truncation_adap(A,form,M,comp_tol,Nbe2, chimax)
...
switch form
    ...
    case 'right'
        ...
        truncerr = 0;
        for i1 = M:-1:2    
            [A{i1}, A_remainder_temp, truncerrtemp, chi] = sweep_truncation_adap( A{i1},form,size(A{i1},1),size(A{i1},2),size(A{i1},3), comp_tol, chimax);
